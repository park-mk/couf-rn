        ...
        return (
            ...
            <View>  
                  <Dialog
                    ...
                    title="DEAR USER"
                    onTouchOutside={() => this.agree()} >
                    <View>
                        <Text style={{ fontSize: 20, color: 'grey' }}> Before uploading your content, do you agree with us in gaining access to your photos and providing them to others that you have chosen to upload? And do you consent that there are no objectionable or abusive content within these photos?</Text>
                    ...
                    rightComponent={
                        ...
                        >
                            <Image source={require('../assets/alarm.png')}
                                ...
                                style={{ width: 33, height: 33, marginLeft: -15, marginTop:15,resizeMode: 'cover' }}
                            />
                        </TouchableOpacity>
                    }
                    backgroundColor={'#fff'}
