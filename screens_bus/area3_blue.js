...
class BLUE extends React.Component {
    ...
    constructor(props) {
        super(props);    
        this.state={
            timeofcircle:78,   // 32+34 =66  일분을 길이 66으로 치환 한다 
            // 한바퀴 돌때 걸리는 시간  78
            circlelength:5148,//  한바퀴 다돌려면 78 분 걸림 78 분 * 66 길이 즉 총길이는 5148임 
            //  한바퀴 총길이 
        ...
        <View   style={{  flex:10}}>
          ...
          />
             ...
             <View   style={{  height:32, flexDirection:'row'}}>
                ...
                <Text style={{ marginTop:-10,marginLeft:0,fontSize:30}} >New 3rd MI Bn</Text>
            </View> 
             ...
             <View   style={{  height:32, flexDirection:'row'}}>
                ...
                <Text style={{ marginTop:-10,marginLeft:0,fontSize:30}} >Lodgin S-121</Text>
             </View> 
             ...
             <View   style={{  height:32, flexDirection:'row'}}>
                ...
                <Text style={{ marginTop:-10,marginLeft:0,fontSize:30}} >Spartan S-6321</Text>
             </View> 
                <Surface width={100} height={100}>
                    <Shape d={path2} stroke="#000000" fill="#2c4ed6" strokeWidth={1} />
                </Surface>
