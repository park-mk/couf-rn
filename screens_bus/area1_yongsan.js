...
centerComponent={{ text: 'BUS', style: {fontFamily:'Bebas Neue Regular' ,fontSize:40,marginLeft:10,color:'#56B8FF' } }}
 ...
 />
  ...
  <Text  style={{fontSize:30,textAlign:'center',fontFamily:'Bebas Neue Regular'}}>{new Date().getDay() }</Text>
         ...
         <Text  style={{marginTop:20,fontSize:30,textAlign:'center',fontFamily:'Bebas Neue Regular',color:"#d11f1f"}}>YONGSAN BUS ROUTE</Text>
