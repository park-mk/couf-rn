...
class UNDEVELOP2 extends React.Component {
   ...
   /> 
      ...
      borderBottomColor={'#fff'}
        ...
        >
          ...
          <Text style={{fontSize:30,marginLeft:10,fontFamily:'title-font',marginRight:20}}> Due to various circumstances, we are not currently supporting this service. we hope this service will be available soon! </Text>
